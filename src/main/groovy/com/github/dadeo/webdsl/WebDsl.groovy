...
import com.github.dadeo.webdsl.support.DslFactory
import com.github.dadeo.webdsl.support.FormDsl
import com.github.dadeo.webdsl.support.PageContainer
import com.github.dadeo.webdsl.support.css.selector.CssSelector
...
class WebDsl implements PageContainer {
    ...
    private Closure elementSortOrder() {
        int counter = 0
        Map<HtmlElement, Integer> sortOrder = ((HtmlPage) page).htmlElementDescendants.collectEntries {
            [it, counter++]
        }
