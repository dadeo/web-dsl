...
import com.github.dadeo.webdsl.support.ButtonInputDsl

@Mixin(NonServerMixin)
class ButtonInputDslTest {

  @Test
  void test_dsl_instance() {
    html {
      form {
        input(name: "name", id: "id", type: 'button', value: ' MYVALUE ')
      }
    }

    webdsl {
      assert $("#id") instanceof ButtonInputDsl
    }
  }
  ...
  void test_setValue() {
    html {
      form {
        input(name: "name", id: "id", type: 'button', value: 'ABC')
      }
    }
  ...
  void test_fillInWith_by_name_input() {
    html {
      form {
        input(name: "name", id: "id", type: 'button')
      }
    }
  ...
  void test_values() {
    html {
      form {
        input(name: "name", type: 'button', value: "MYVALUE")
      }
    }
  ...
  void test_valuesById_input() {
    html {
      form {
        input(id: "id", type: 'button', name: "name", value: "MYVALUE")
      }
    }
