...
import com.github.dadeo.webdsl.support.ResetInputDsl

@Mixin(NonServerMixin)
class ResetInputDslTest {

  @Test
  void test_dsl_instance() {
    html {
      form {
        input(name: "name", id: "id", type: 'reset', value: ' MYVALUE ')
      }
    }

    webdsl {
      assert $("#id") instanceof ResetInputDsl
    }
  }
  ...
  void test_setValue() {
    html {
      form {
        input(name: "name", id: "id", type: 'reset', value: 'ABC')
      }
    }
  ...
  void test_fillInWith_by_name_input() {
    html {
      form {
        input(name: "name", id: "id", type: 'reset')
      }
    }
  ...
  void test_fillInWith_by_id() {
    html {
      form {
        input(id: "id", name: "name", type: 'reset')
      }
    }
  ...
  void test_values() {
    html {
      form {
        input(name: "name", type: 'reset', value: "MYVALUE")
      }
    }
  ...
  void test_valuesById_input() {
    html {
      form {
        input(id: "id", type: 'reset', name: "name", value: "MYVALUE")
      }
    }
