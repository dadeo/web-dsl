...
import com.github.dadeo.webdsl.support.SubmitInputDsl

@Mixin(NonServerMixin)
class SubmitInputDslTest {

  @Test
  void test_dsl_instance() {
    html {
      form {
        input(name: "name", id: "id", type: 'submit', value: ' MYVALUE ')
      }
    }

    webdsl {
      assert $("#id") instanceof SubmitInputDsl
    }
  }
  ...
  void test_setValue() {
    html {
      form {
        input(name: "name", id: "id", type: 'submit', value: 'ABC')
      }
    }
  ...
  void test_fillInWith_by_name_input() {
    html {
      form {
        input(name: "name", id: "id", type: 'submit')
      }
    }
  ...
  void test_fillInWith_by_id() {
    html {
      form {
        input(id: "id", name: "name", type: 'submit')
      }
    }
  ...
  void test_values() {
    html {
      form {
        input(name: "name", type: 'submit', value: "MYVALUE")
      }
    }
  ...
  void test_valuesById_input() {
    html {
      form {
        input(id: "id", type: 'submit', name: "name", value: "MYVALUE")
      }
    }
