...
class WebDslTest {
    ...
    void test_httpGet_url_and_parameters() {
        JettyRunner.withServer() {
            ...
            assert webDsl.$('#parameters').do(startRow: 1).as.object(orientation: Orientation.VERTICAL) == [a: '1', b: '2', c: '', d: '4']
        }
    }
    ...
    void test_httpGet_url_and_no_parameters() {
        JettyRunner.withServer() {
            ...
            assert webDsl.title == 'TestServlet test.html'
            assert webDsl.$('#methodType').value == 'GET'
            assert webDsl.$('#parameters').do(startRow: 1).as.object(orientation: Orientation.VERTICAL) == [:]
        }
    }
    ...
    void test_httpGet_url_string_and_no_parameters() {
        JettyRunner.withServer() {
            ...
            assert webDsl.title == 'TestServlet test.html'
            assert webDsl.$('#methodType').value == 'GET'
            assert webDsl.$('#parameters').do(columnOffset: 1).as.object == [:]
        }
    }
